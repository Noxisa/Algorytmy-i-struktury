...
### Zawartość
- [ALGORYTM EUKLIDESA](https://github.com/Noxisa/Algorytmy-i-struktury/blob/Projekt.md#:~:text=ko%C5%84ca%20listy%20jednokierunkowej-,ALGORYTM%20EUKLIDESA)
- [Algorytm Knutha-Morrisa-Pratta Wyszukiwania wzorca](https://github.com/Noxisa/Algorytmy-i-struktury/blob/Projekt.md#:~:text=Algorytm%20Knutha%2DMorrisa%2DPratta%20wyszukiwania%20wzorca,-Algorytm%20Knutha%2DMorrisa)
...
** Przykłady zastosowania algorytmu Knutha-Morrisa-Pratta to wyszukiwanie danych w dużych bazach danych, wyszukiwanie wzorców w genomie i w tekście, a także wyszukiwanie plików z danymi w systemie plików.**
